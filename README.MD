...
The library uses Timer1 on the UNO, Nano, Leonardo, and Sparkfun Pro Micro so you will no longer be able to call `analogWrite()` on pins 9 or 10.
...
- On the Mega the input capture pin used is pin 49.
