...
The size of the library is also very compact. Using only 666 bytes of flash, and 16 bytes of RAM on an Arduino Nano. 
...
| Platform | Pins |
|-|-|
| UNO, Nano, Pro Mini, Micro, Leonardo, Sparkfun Pro Micro | 9, 10 |
| Mega | 6, 7, 8 |
