...
Low RPM values are more difficult to measure than higher ones. There will ultimately be a lower limit at which data will start to break down the lower the RPM becomes.
